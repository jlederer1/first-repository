...
// Welcome phrases (randomly chosen from)
//
// (You probably don't need to touch this list for the assignment.)
//
var elizaInitials = [
...
// Goodbye phrases (randomly chosen from)
//
// (You probably don't need to touch this list for the assignment.)
//
var elizaFinals = [
...
// Keywords that indicate that the user wants to end the chat
//
// (You probably don't need to touch this list for the assignment.)
//
var elizaQuits = [
...
// Preprocessing: The list contains pairs of strings. If a first part is recognized,
// it will be replaced by the second parts.
//
// Example: Any occurence of "artificial intelligence" will be replaced by "ai", so you
// can refer to the keyword ai later.
//
// Assignment: Add any replacements for cogntive science specific terms/abbreviations
// that you want treat equally.
//
// Note: Make sure to always add TWO strings delimited by ,
//
var elizaPres = [
    "dont", "don't",
    "cant", "can't",
...
// Postprocessing. The list contains pairs of strings that
// are replaced in the output. Here, especially I and you are
// transformed.
//
// (You probably don't need to touch this list for the assignment.)
//
...
// be treated equally in rules, but they don't have to. (That's the difference to the
// preprocessing rules above).
//
// Assignment: Add lists of terms here that you want to treat equally in some rule below.
//
var elizaSynons = {
    "be": ["am", "is", "are", "was"],
...
var elizaKeywords = [
    ...
    */
    ...
    ["feeling", 50, [
        ...
        ["*", [
            "Please portray your feelings in more detail!",
    ...
    ["improve", 100, [
        ["$ * improve * by *", [
            "(3), is the ideal way to deal with our crisis! Any other issues?",
